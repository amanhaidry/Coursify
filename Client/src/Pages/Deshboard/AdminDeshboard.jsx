      ...
      datasets: [
        {
          ...
          backgroundColor: ["#00ad4c ", "#ffc107"],
          borderWidth: 1,
          borderColor: ["yellow-800", "green-800"],
        },
      ],
    };
            ...
            <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
                    ...
                    <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                ...
                                <GiMoneyStack className="text-green-700 text-5xl"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className=" lg:mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
                    <div className="flex w-full items-center justify-between">
                        ...
                        className="w-fit bg-yellow-600 hover:bg-yellow-600 transition-all ease-in-out duration-300 rounded py-2 px-2 sm:px-4 font-semibold sm:text-lg cursor-pointer"
                        >
                        Create new course
                        </button>
                    </div>
                        ...
                        <tbody>
                            ...
                            return (
                                ...
                                <td className="flex items-center gap-4">
                                    ...
                                    <button
                                        className="bg-green-600 hover:bg-green-700 transition-all ease-in-out duration-300 text-xl py-2 px-3 rounded-md font-bold"
                                        onClick={() =>
                                    ...
                                    <button
                                        className=" bg-yellow-600 hover:bg-yellow-700 transition-all ease-in-out duration-300 text-xl py-2 px-3 rounded-md font-bold"
                                        onClick={() => 
                                    ...
                                    <button
                                        className="bg-red-800 hover:bg-red-900 transition-all ease-in-out duration-300 text-xl py-2 px-3 rounded-md font-bold"
